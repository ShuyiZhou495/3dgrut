...
threedgut::Status threedgut::GUTRenderer::renderForward(const RenderParameters& params,
                                                        ...
                                                        vec4* worldGGGSDebugCudaPtr,
                                                        vec4* worldGGGSTransmittanceDebugCudaPtr,
                                                        vec4* worldGGGSSearchDebugCudaPtr,
...

    {
        ...
        ::renderBalanced<<<virtual_tiles_total, ThreadsPerBlock, 0, cudaStream>>>( // ThreadsPerBlock = FineGrainedWarpsPerBlock * WarpSize
            ...
            worldNormalCudaPtr,
            worldGGGSDebugCudaPtr,
            worldGGGSTransmittanceDebugCudaPtr,
            worldGGGSSearchDebugCudaPtr,
